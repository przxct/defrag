...
for line in sys.stdin:
	...
	if (id < 10):
		print("line: ",curWords)
		print("curWords chrColumn: ", curWords[chrColumn])
		print("prevWords chrColumn: ", prevWords[chrColumn])
		print("curWords startColumn: ", curWords[startColumn])
		print("prevWords startColumn: ", prevWords[startColumn])
...
with open('log_chr_bam.txt', 'w') as convert_file: 
