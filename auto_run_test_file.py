...
def main():
    ...
    REF_DIR = "./ref"
    directories = ["/Users/nguyenngocanh/Desktop/lab/seqff/real_data/npz_negatives/train_seqff/"]
    outfile = "./npzdir/train/"
    ...
    subprocess.call(['python3', 'defrag_to_log_ff.py', './boydir', './girldir', './npzdir/train/', './output/figure'])
